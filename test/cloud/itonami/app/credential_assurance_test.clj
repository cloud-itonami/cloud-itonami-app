(ns cloud.itonami.app.credential-assurance-test
  ...
  (:require [clojure.string :as str]
            ...
            [cloud.itonami.app.credential-assurance :as ca]))
...
(deftest a-policy-comes-from-configuration-and-falls-back-to-the-default
  (is (= ca/default-policy (ca/policy-for {} :payment)))
  (is (= :platform-attested
         (:min-assurance
          (ca/policy-for {:authorities
                          {:payment {:credential-policy
                                     {:min-assurance :platform-attested}}}}
                         :payment)))
