...
| profile | description |
|---|---|
| `itonami-dispatch` | cloud-itonami 各 business の bot 群を murakumo fleet 上で分散稼働させる dispatch bot。kanban |
| `itonami-maint` |  |
| `itonami-winfix` |  |
| `itonami-winfix-qa` | itonami qa |
| `refactor` | refactor — clj, cljc を kotoba に refactor するよ. jvm 依存を外して, amu, kotoba |
